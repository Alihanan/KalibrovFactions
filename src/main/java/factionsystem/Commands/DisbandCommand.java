...
public class DisbandCommand {
    ...
    public void removeFaction(int i) {
        ...
        for (Faction faction : main.factions) {
            ...
            if (faction.isTradeAlly(main.factions.get(i).getName())) {
            	faction.removeTradeAlly(main.factions.get(i).getName());
            }
        }
        
        // Remove all tradePoints
        main.factions.get(i).DeleteTradePoint();
